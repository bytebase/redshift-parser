...
import (
	...
	pgparser "github.com/bytebase/redshift-parser"
...
type ParseService struct {
	lexer  *pgparser.RedshiftLexer
	parser *pgparser.RedshiftParser
...
func NewParseService() *ParseService {
	...
	s.lexer = pgparser.NewRedshiftLexer(s.input)
	s.tokens = antlr.NewCommonTokenStream(s.lexer, 0)
	s.parser = pgparser.NewRedshiftParser(s.tokens)
	return s
}
