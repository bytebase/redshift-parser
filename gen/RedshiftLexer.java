// Generated from /Users/h3n4l/OpenSource/redshift-parser/RedshiftLexer.g4 by ANTLR 4.13.2
...
public class RedshiftLexer extends RedshiftLexerBase {
	...
	public static final int
		...
		COPY=169, COST=170, CSV=171, JSON=172, CURSOR=173, CYCLE=174, DATA_P=175, 
		DATA_CATALOG=176, DATABASE=177, DAY_P=178, DEALLOCATE=179, DECLARE=180, 
		DEFAULTS=181, DEFERRED=182, DEFINER=183, DELETE_P=184, DELIMITER=185, 
		...
		WRITE=377, XML_P=378, YEAR_P=379, YES_P=380, ZONE=381, DATASHARE=382, 
		PUBLICACCESSIBLE=383, INCLUDENEW=384, IAM_ROLE=385, CATALOG_ROLE=386, 
		CATALOG_ID=387, HIVE=388, METASTORE=389, URI=390, POSTGRES=391, MYSQL=392, 
		SECRET_ARN=393, KINESIS=394, KAFKA=395, MSK=396, AUTHENTICATION=397, AUTHENTICATION_ARN=398, 
		SESSION_TOKEN=399, MTLS=400, MASKING=401, RLS=402, IDENTITY=403, PROVIDER=404, 
		MODEL=405, TARGET=406, SAGEMAKER=407, AUTO=408, MODEL_TYPE=409, PROBLEM_TYPE=410, 
		OBJECTIVE=411, PREPROCESSORS=412, HYPERPARAMETERS=413, XGBOOST=414, MLP=415, 
		LINEAR_LEARNER=416, KMEANS=417, FORECAST=418, REGRESSION=419, BINARY_CLASSIFICATION=420, 
		MULTICLASS_CLASSIFICATION=421, S3_BUCKET=422, TAGS=423, KMS_KEY_ID=424, 
		S3_GARBAGE_COLLECT=425, MAX_CELLS=426, MAX_RUNTIME=427, HORIZON=428, FREQUENCY=429, 
		PERCENTILES=430, MAX_BATCH_ROWS=431, UNLOAD=432, MANIFEST=433, ADDQUOTES=434, 
		ALLOWOVERWRITE=435, CLEANPATH=436, MAXFILESIZE=437, ROWGROUPSIZE=438, 
		BZIP2=439, GZIP=440, ZSTD=441, DATABASES=442, DATASHARES=443, GRANTS=444, 
		USE=445, CANCEL=446, SESSION_AUTHORIZATION=447, SESSION_CHARACTERISTICS=448, 
		COMPRESSION=449, LIBRARY=450, APPEND=451, MB=452, GB=453, ACCOUNT=454, 
		NAMESPACE=455, DESCRIBE=456, NONATOMIC=457, MANAGEDBY=458, ADX=459, REMOVE=460, 
		PLPYTHONU=461, FILLTARGET=462, IGNOREEXTRA=463, CREATEUSER=464, NOCREATEUSER=465, 
		PORT=466, REDSHIFT=467, IAM=468, CREATEDB=469, NOCREATEDB=470, RESTRICTED=471, 
		UNLIMITED=472, EXTERNALID=473, TIMEOUT=474, SYSLOG=475, CREDENTIALS=476, 
		UNRESTRICTED=477, PARAMETERS=478, APPLICATION_ARN=479, AUTO_CREATE_ROLES=480, 
		COMPROWS=481, PROVIDER_URL=482, PROVIDER_URL_PORT=483, ATTRIBUTE_MAP=484, 
		PROVIDER_ARN=485, ASSUME_ROLE_ARN=486, PROPERTIES=487, AVRO=488, RCFILE=489, 
		SEQUENCEFILE=490, TEXTFILE=491, ORC=492, ION=493, LAMBDA=494, FIXEDWIDTH=495, 
		PARQUET=496, HEADER=497, SETTINGS=498, FUNCTION_NAME=499, ATOMIC_P=500, 
		BETWEEN=501, BIGINT=502, BIT=503, BOOLEAN_P=504, CHAR_P=505, CHARACTER=506, 
		COALESCE=507, DEC=508, DECIMAL_P=509, EXISTS=510, EXTRACT=511, FLOAT_P=512, 
		GREATEST=513, INOUT=514, INT_P=515, INTEGER=516, INTERVAL=517, LEAST=518, 
		NATIONAL=519, NCHAR=520, NONE=521, NULLIF=522, NUMERIC=523, OVERLAY=524, 
		PARAMETER=525, POSITION=526, PRECISION=527, REAL=528, ROW=529, SETOF=530, 
		SMALLINT=531, SUBSTRING=532, TIME=533, TIMESTAMP=534, TREAT=535, TRIM=536, 
		VALUES=537, VARCHAR=538, XMLATTRIBUTES=539, XMLCOMMENT=540, XMLAGG=541, 
		XML_IS_WELL_FORMED=542, XML_IS_WELL_FORMED_DOCUMENT=543, XML_IS_WELL_FORMED_CONTENT=544, 
		XPATH=545, XPATH_EXISTS=546, XMLCONCAT=547, XMLELEMENT=548, XMLEXISTS=549, 
		XMLFOREST=550, XMLPARSE=551, XMLPI=552, XMLROOT=553, XMLSERIALIZE=554, 
		CALL=555, CURRENT_P=556, ATTACH=557, DETACH=558, EXPRESSION=559, GENERATED=560, 
		LOGGED=561, STORED=562, SERDE=563, SERDEPROPERTIES=564, INPUTFORMAT=565, 
		OUTPUTFORMAT=566, FIELDS=567, COLLECTION=568, ITEMS=569, TERMINATED=570, 
		ESCAPED=571, DEFINED=572, LINES=573, KEYS=574, PARTITIONED=575, STRUCT=576, 
		MAP=577, STRING=578, DELIMITED=579, INCLUDE=580, ROUTINE=581, TRANSFORM=582, 
		IMPORT_P=583, POLICY=584, PRIORITY=585, METHOD=586, REFERENCING=587, NEW=588, 
		OLD=589, VALUE_P=590, SUBSCRIPTION=591, PUBLICATION=592, OUT_P=593, END_P=594, 
		ROUTINES=595, SCHEMAS=596, PROCEDURES=597, INPUT_P=598, SUPPORT=599, PARALLEL=600, 
		SQL_P=601, DEPENDS=602, OVERRIDING=603, CONFLICT=604, SKIP_P=605, LOCKED=606, 
		TIES=607, ROLLUP=608, CUBE=609, GROUPING=610, SETS=611, TABLESAMPLE=612, 
		ORDINALITY=613, XMLTABLE=614, COLUMNS=615, XMLNAMESPACES=616, ROWTYPE=617, 
		NORMALIZED=618, WITHIN=619, FILTER=620, GROUPS=621, OTHERS=622, NFC=623, 
		NFD=624, NFKC=625, NFKD=626, UESCAPE=627, VIEWS=628, NORMALIZE=629, DUMP=630, 
		PRINT_STRICT_PARAMS=631, VARIABLE_CONFLICT=632, ERROR=633, USE_VARIABLE=634, 
		USE_COLUMN=635, ALIAS=636, CONSTANT=637, PERFORM=638, GET=639, DIAGNOSTICS=640, 
		STACKED=641, ELSIF=642, WHILE=643, REVERSE=644, FOREACH=645, SLICE=646, 
		EXIT=647, RETURN=648, QUERY=649, RAISE=650, SQLSTATE=651, DEBUG=652, LOG=653, 
		INFO=654, NOTICE=655, WARNING=656, EXCEPTION=657, ASSERT=658, LOOP=659, 
		OPEN=660, ABS=661, CBRT=662, CEIL=663, CEILING=664, DEGREES=665, DIV=666, 
		EXP=667, FACTORIAL=668, FLOOR=669, GCD=670, LCM=671, LN=672, LOG10=673, 
		MIN_SCALE=674, MOD=675, PI=676, POWER=677, RADIANS=678, ROUND=679, SCALE=680, 
		SIGN=681, SQRT=682, TRIM_SCALE=683, TRUNC=684, WIDTH_BUCKET=685, RANDOM=686, 
		SETSEED=687, ACOS=688, ACOSD=689, ASIN=690, ASIND=691, ATAN=692, ATAND=693, 
		ATAN2=694, ATAN2D=695, COS=696, COSD=697, COT=698, COTD=699, SIN=700, 
		SIND=701, TAN=702, TAND=703, SINH=704, COSH=705, TANH=706, ASINH=707, 
		ACOSH=708, ATANH=709, BIT_LENGTH=710, CHAR_LENGTH=711, CHARACTER_LENGTH=712, 
		LOWER=713, OCTET_LENGTH=714, UPPER=715, ASCII=716, BTRIM=717, CHR=718, 
		CONCAT=719, CONCAT_WS=720, FORMAT=721, INITCAP=722, LENGTH=723, LPAD=724, 
		LTRIM=725, MD5=726, PARSE_IDENT=727, PG_CLIENT_ENCODING=728, QUOTE_IDENT=729, 
		QUOTE_LITERAL=730, QUOTE_NULLABLE=731, REGEXP_COUNT=732, REGEXP_INSTR=733, 
		REGEXP_LIKE=734, REGEXP_MATCH=735, REGEXP_MATCHES=736, REGEXP_REPLACE=737, 
		REGEXP_SPLIT_TO_ARRAY=738, REGEXP_SPLIT_TO_TABLE=739, REGEXP_SUBSTR=740, 
		REPEAT=741, RPAD=742, RTRIM=743, SPLIT_PART=744, STARTS_WITH=745, STRING_TO_ARRAY=746, 
		STRING_TO_TABLE=747, STRPOS=748, SUBSTR=749, TO_ASCII=750, TO_HEX=751, 
		TRANSLATE=752, UNISTR=753, AGE=754, CLOCK_TIMESTAMP=755, DATE_BIN=756, 
		DATE_PART=757, DATE_TRUNC=758, ISFINITE=759, JUSTIFY_DAYS=760, JUSTIFY_HOURS=761, 
		JUSTIFY_INTERVAL=762, MAKE_DATE=763, MAKE_INTERVAL=764, MAKE_TIME=765, 
		MAKE_TIMESTAMP=766, MAKE_TIMESTAMPTZ=767, NOW=768, STATEMENT_TIMESTAMP=769, 
		TIMEOFDAY=770, TRANSACTION_TIMESTAMP=771, TO_TIMESTAMP=772, TO_CHAR=773, 
		TO_DATE=774, TO_NUMBER=775, ENCODE=776, DISTKEY=777, SORTKEY=778, CASE_SENSITIVE=779, 
		CASE_INSENSITIVE=780, Identifier=781, QuotedIdentifier=782, UnterminatedQuotedIdentifier=783, 
		InvalidQuotedIdentifier=784, InvalidUnterminatedQuotedIdentifier=785, 
		UnicodeQuotedIdentifier=786, UnterminatedUnicodeQuotedIdentifier=787, 
		InvalidUnicodeQuotedIdentifier=788, InvalidUnterminatedUnicodeQuotedIdentifier=789, 
		StringConstant=790, UnterminatedStringConstant=791, UnicodeEscapeStringConstant=792, 
		UnterminatedUnicodeEscapeStringConstant=793, BeginDollarStringConstant=794, 
		BinaryStringConstant=795, UnterminatedBinaryStringConstant=796, InvalidBinaryStringConstant=797, 
		InvalidUnterminatedBinaryStringConstant=798, HexadecimalStringConstant=799, 
		UnterminatedHexadecimalStringConstant=800, InvalidHexadecimalStringConstant=801, 
		InvalidUnterminatedHexadecimalStringConstant=802, Integral=803, NumericFail=804, 
		Numeric=805, PLSQLVARIABLENAME=806, PLSQLIDENTIFIER=807, Whitespace=808, 
		Newline=809, LineComment=810, BlockComment=811, UnterminatedBlockComment=812, 
		MetaCommand=813, EndMetaCommand=814, ErrorCharacter=815, EscapeStringConstant=816, 
		UnterminatedEscapeStringConstant=817, InvalidEscapeStringConstant=818, 
		InvalidUnterminatedEscapeStringConstant=819, AfterEscapeStringConstantMode_NotContinued=820, 
		AfterEscapeStringConstantWithNewlineMode_NotContinued=821, DollarText=822, 
		EndDollarStringConstant=823, AfterEscapeStringConstantWithNewlineMode_Continued=824;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"YEAR_P", "YES_P", "ZONE", "DATASHARE", "PUBLICACCESSIBLE", "INCLUDENEW", 
			...
			"PROVIDER", "MODEL", "TARGET", "SAGEMAKER", "AUTO", "MODEL_TYPE", "PROBLEM_TYPE", 
			...
			"ROWGROUPSIZE", "BZIP2", "GZIP", "ZSTD", "DATABASES", "DATASHARES", "GRANTS", 
			"USE", "CANCEL", "SESSION_AUTHORIZATION", "SESSION_CHARACTERISTICS", 
			"COMPRESSION", "LIBRARY", "APPEND", "MB", "GB", "ACCOUNT", "NAMESPACE", 
			"DESCRIBE", "NONATOMIC", "MANAGEDBY", "ADX", "REMOVE", "PLPYTHONU", "FILLTARGET", 
			...
			"NUMERIC", "OVERLAY", "PARAMETER", "POSITION", "PRECISION", "REAL", "ROW", 
			...
			"SCHEMAS", "PROCEDURES", "INPUT_P", "SUPPORT", "PARALLEL", "SQL_P", "DEPENDS", 
			...
			"USE_COLUMN", "ALIAS", "CONSTANT", "PERFORM", "GET", "DIAGNOSTICS", "STACKED", 
			"ELSIF", "WHILE", "REVERSE", "FOREACH", "SLICE", "EXIT", "RETURN", "QUERY", 
			"RAISE", "SQLSTATE", "DEBUG", "LOG", "INFO", "NOTICE", "WARNING", "EXCEPTION", 
			"ASSERT", "LOOP", "OPEN", "ABS", "CBRT", "CEIL", "CEILING", "DEGREES", 
			"DIV", "EXP", "FACTORIAL", "FLOOR", "GCD", "LCM", "LN", "LOG10", "MIN_SCALE", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'EXPLAIN'", "'EXTENSION'", "'EXTERNAL'", "'FAMILY'", "'FIRST'", "'FOLLOWING'", 
			"'FORCE'", "'FORWARD'", "'FUNCTION'", "'FUNCTIONS'", "'GLOBAL'", "'GRANTED'", 
			"'HANDLER'", null, "'HOLD'", "'HOUR'", null, "'IF'", "'IMMEDIATE'", "'IMMUTABLE'", 
			...
			"'SEQUENCE'", "'SEQUENCES'", "'SERIALIZABLE'", "'SERVER'", null, "'SET'", 
			...
			"'TEMP'", "'TEMPLATE'", "'TEMPORARY'", "'TEXT'", "'TRANSACTION'", "'TRIGGER'", 
			...
			"'WRAPPER'", "'WRITE'", "'XML'", "'YEAR'", "'YES'", "'ZONE'", "'DATASHARE'", 
			...
			"'AUTHENTICATION_ARN'", null, "'MTLS'", "'MASKING'", "'RLS'", null, "'PROVIDER'", 
			...
			"'S3_GARBAGE_COLLECT'", "'MAX_CELLS'", "'MAX_RUNTIME'", "'HORIZON'", 
			"'FREQUENCY'", "'PERCENTILES'", "'MAX_BATCH_ROWS'", "'UNLOAD'", "'MANIFEST'", 
			"'ADDQUOTES'", "'ALLOWOVERWRITE'", "'CLEANPATH'", "'MAXFILESIZE'", "'ROWGROUPSIZE'", 
			"'BZIP2'", "'GZIP'", "'ZSTD'", "'DATABASES'", "'DATASHARES'", "'GRANTS'", 
			"'USE'", "'CANCEL'", "'SESSION_AUTHORIZATION'", "'SESSION_CHARACTERISTICS'", 
			"'COMPRESSION'", "'LIBRARY'", "'APPEND'", "'MB'", "'GB'", "'ACCOUNT'", 
			"'NAMESPACE'", "'DESCRIBE'", "'NONATOMIC'", "'MANAGEDBY'", "'ADX'", "'REMOVE'", 
			"'PLPYTHONU'", "'FILLTARGET'", "'IGNOREEXTRA'", "'CREATEUSER'", "'NOCREATEUSER'", 
			"'PORT'", "'REDSHIFT'", "'IAM'", "'CREATEDB'", "'NOCREATEDB'", "'RESTRICTED'", 
			...
			"'PARQUET'", null, "'SETTINGS'", "'FUNCTION_NAME'", "'ATOMIC'", "'BETWEEN'", 
			...
			"'DELIMITED'", "'INCLUDE'", "'ROUTINE'", "'TRANSFORM'", "'IMPORT'", "'POLICY'", 
			...
			"'ATANH'", "'BIT_LENGTH'", "'CHAR_LENGTH'", "'CHARACTER_LENGTH'", "'LOWER'", 
			...
			"'TO_NUMBER'", "'ENCODE'", "'DISTKEY'", "'SORTKEY'", "'CASE_SENSITIVE'", 
			"'CASE_INSENSITIVE'", null, null, null, null, null, null, null, null, 
	...
	@Override
	public String getGrammarFileName() { return "RedshiftLexer.g4"; }
