...
public class RedshiftLexer extends RedshiftLexerBase {
	...
	public static final int
		...
		NAMESPACE=455, DESCRIBE=456, MANAGEDBY=457, ADX=458, REMOVE=459, PLPYTHONU=460, 
		FILLTARGET=461, IGNOREEXTRA=462, CREATEUSER=463, NOCREATEUSER=464, PORT=465, 
		REDSHIFT=466, IAM=467, CREATEDB=468, NOCREATEDB=469, RESTRICTED=470, UNLIMITED=471, 
		EXTERNALID=472, TIMEOUT=473, SYSLOG=474, CREDENTIALS=475, UNRESTRICTED=476, 
		PARAMETERS=477, APPLICATION_ARN=478, AUTO_CREATE_ROLES=479, COMPROWS=480, 
		PROVIDER_URL=481, PROVIDER_URL_PORT=482, ATTRIBUTE_MAP=483, PROVIDER_ARN=484, 
		ASSUME_ROLE_ARN=485, PROPERTIES=486, AVRO=487, RCFILE=488, SEQUENCEFILE=489, 
		TEXTFILE=490, ORC=491, ION=492, LAMBDA=493, FIXEDWIDTH=494, PARQUET=495, 
		HEADER=496, SETTINGS=497, FUNCTION_NAME=498, ATOMIC_P=499, BETWEEN=500, 
		BIGINT=501, BIT=502, BOOLEAN_P=503, CHAR_P=504, CHARACTER=505, COALESCE=506, 
		DEC=507, DECIMAL_P=508, EXISTS=509, EXTRACT=510, FLOAT_P=511, GREATEST=512, 
		INOUT=513, INT_P=514, INTEGER=515, INTERVAL=516, LEAST=517, NATIONAL=518, 
		NCHAR=519, NONE=520, NULLIF=521, NUMERIC=522, OVERLAY=523, PARAMETER=524, 
		POSITION=525, PRECISION=526, REAL=527, ROW=528, SETOF=529, SMALLINT=530, 
		SUBSTRING=531, TIME=532, TIMESTAMP=533, TREAT=534, TRIM=535, VALUES=536, 
		VARCHAR=537, XMLATTRIBUTES=538, XMLCOMMENT=539, XMLAGG=540, XML_IS_WELL_FORMED=541, 
		XML_IS_WELL_FORMED_DOCUMENT=542, XML_IS_WELL_FORMED_CONTENT=543, XPATH=544, 
		XPATH_EXISTS=545, XMLCONCAT=546, XMLELEMENT=547, XMLEXISTS=548, XMLFOREST=549, 
		XMLPARSE=550, XMLPI=551, XMLROOT=552, XMLSERIALIZE=553, CALL=554, CURRENT_P=555, 
		ATTACH=556, DETACH=557, EXPRESSION=558, GENERATED=559, LOGGED=560, STORED=561, 
		SERDE=562, SERDEPROPERTIES=563, INPUTFORMAT=564, OUTPUTFORMAT=565, FIELDS=566, 
		COLLECTION=567, ITEMS=568, TERMINATED=569, ESCAPED=570, DEFINED=571, LINES=572, 
		KEYS=573, PARTITIONED=574, STRUCT=575, MAP=576, STRING=577, DELIMITED=578, 
		INCLUDE=579, ROUTINE=580, TRANSFORM=581, IMPORT_P=582, POLICY=583, PRIORITY=584, 
		METHOD=585, REFERENCING=586, NEW=587, OLD=588, VALUE_P=589, SUBSCRIPTION=590, 
		PUBLICATION=591, OUT_P=592, END_P=593, ROUTINES=594, SCHEMAS=595, PROCEDURES=596, 
		INPUT_P=597, SUPPORT=598, PARALLEL=599, SQL_P=600, DEPENDS=601, OVERRIDING=602, 
		CONFLICT=603, SKIP_P=604, LOCKED=605, TIES=606, ROLLUP=607, CUBE=608, 
		GROUPING=609, SETS=610, TABLESAMPLE=611, ORDINALITY=612, XMLTABLE=613, 
		COLUMNS=614, XMLNAMESPACES=615, ROWTYPE=616, NORMALIZED=617, WITHIN=618, 
		FILTER=619, GROUPS=620, OTHERS=621, NFC=622, NFD=623, NFKC=624, NFKD=625, 
		UESCAPE=626, VIEWS=627, NORMALIZE=628, DUMP=629, PRINT_STRICT_PARAMS=630, 
		VARIABLE_CONFLICT=631, ERROR=632, USE_VARIABLE=633, USE_COLUMN=634, ALIAS=635, 
		CONSTANT=636, PERFORM=637, GET=638, DIAGNOSTICS=639, STACKED=640, ELSIF=641, 
		WHILE=642, REVERSE=643, FOREACH=644, SLICE=645, EXIT=646, RETURN=647, 
		QUERY=648, RAISE=649, SQLSTATE=650, DEBUG=651, LOG=652, INFO=653, NOTICE=654, 
		WARNING=655, EXCEPTION=656, ASSERT=657, LOOP=658, OPEN=659, ABS=660, CBRT=661, 
		CEIL=662, CEILING=663, DEGREES=664, DIV=665, EXP=666, FACTORIAL=667, FLOOR=668, 
		GCD=669, LCM=670, LN=671, LOG10=672, MIN_SCALE=673, MOD=674, PI=675, POWER=676, 
		RADIANS=677, ROUND=678, SCALE=679, SIGN=680, SQRT=681, TRIM_SCALE=682, 
		TRUNC=683, WIDTH_BUCKET=684, RANDOM=685, SETSEED=686, ACOS=687, ACOSD=688, 
		ASIN=689, ASIND=690, ATAN=691, ATAND=692, ATAN2=693, ATAN2D=694, COS=695, 
		COSD=696, COT=697, COTD=698, SIN=699, SIND=700, TAN=701, TAND=702, SINH=703, 
		COSH=704, TANH=705, ASINH=706, ACOSH=707, ATANH=708, BIT_LENGTH=709, CHAR_LENGTH=710, 
		CHARACTER_LENGTH=711, LOWER=712, OCTET_LENGTH=713, UPPER=714, ASCII=715, 
		BTRIM=716, CHR=717, CONCAT=718, CONCAT_WS=719, FORMAT=720, INITCAP=721, 
		LENGTH=722, LPAD=723, LTRIM=724, MD5=725, PARSE_IDENT=726, PG_CLIENT_ENCODING=727, 
		QUOTE_IDENT=728, QUOTE_LITERAL=729, QUOTE_NULLABLE=730, REGEXP_COUNT=731, 
		REGEXP_INSTR=732, REGEXP_LIKE=733, REGEXP_MATCH=734, REGEXP_MATCHES=735, 
		REGEXP_REPLACE=736, REGEXP_SPLIT_TO_ARRAY=737, REGEXP_SPLIT_TO_TABLE=738, 
		REGEXP_SUBSTR=739, REPEAT=740, RPAD=741, RTRIM=742, SPLIT_PART=743, STARTS_WITH=744, 
		STRING_TO_ARRAY=745, STRING_TO_TABLE=746, STRPOS=747, SUBSTR=748, TO_ASCII=749, 
		TO_HEX=750, TRANSLATE=751, UNISTR=752, AGE=753, CLOCK_TIMESTAMP=754, DATE_BIN=755, 
		DATE_PART=756, DATE_TRUNC=757, ISFINITE=758, JUSTIFY_DAYS=759, JUSTIFY_HOURS=760, 
		JUSTIFY_INTERVAL=761, MAKE_DATE=762, MAKE_INTERVAL=763, MAKE_TIME=764, 
		MAKE_TIMESTAMP=765, MAKE_TIMESTAMPTZ=766, NOW=767, STATEMENT_TIMESTAMP=768, 
		TIMEOFDAY=769, TRANSACTION_TIMESTAMP=770, TO_TIMESTAMP=771, TO_CHAR=772, 
		TO_DATE=773, TO_NUMBER=774, ENCODE=775, DISTKEY=776, SORTKEY=777, CASE_SENSITIVE=778, 
		CASE_INSENSITIVE=779, Identifier=780, QuotedIdentifier=781, UnterminatedQuotedIdentifier=782, 
		InvalidQuotedIdentifier=783, InvalidUnterminatedQuotedIdentifier=784, 
		UnicodeQuotedIdentifier=785, UnterminatedUnicodeQuotedIdentifier=786, 
		InvalidUnicodeQuotedIdentifier=787, InvalidUnterminatedUnicodeQuotedIdentifier=788, 
		StringConstant=789, UnterminatedStringConstant=790, UnicodeEscapeStringConstant=791, 
		UnterminatedUnicodeEscapeStringConstant=792, BeginDollarStringConstant=793, 
		BinaryStringConstant=794, UnterminatedBinaryStringConstant=795, InvalidBinaryStringConstant=796, 
		InvalidUnterminatedBinaryStringConstant=797, HexadecimalStringConstant=798, 
		UnterminatedHexadecimalStringConstant=799, InvalidHexadecimalStringConstant=800, 
		InvalidUnterminatedHexadecimalStringConstant=801, Integral=802, NumericFail=803, 
		Numeric=804, PLSQLVARIABLENAME=805, PLSQLIDENTIFIER=806, Whitespace=807, 
		Newline=808, LineComment=809, BlockComment=810, UnterminatedBlockComment=811, 
		MetaCommand=812, EndMetaCommand=813, ErrorCharacter=814, EscapeStringConstant=815, 
		UnterminatedEscapeStringConstant=816, InvalidEscapeStringConstant=817, 
		InvalidUnterminatedEscapeStringConstant=818, AfterEscapeStringConstantMode_NotContinued=819, 
		AfterEscapeStringConstantWithNewlineMode_NotContinued=820, DollarText=821, 
		EndDollarStringConstant=822, AfterEscapeStringConstantWithNewlineMode_Continued=823;
	public static final int
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DESCRIBE", "MANAGEDBY", "ADX", "REMOVE", "PLPYTHONU", "FILLTARGET", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'NAMESPACE'", "'DESCRIBE'", "'MANAGEDBY'", "'ADX'", "'REMOVE'", "'PLPYTHONU'", 
			"'FILLTARGET'", "'IGNOREEXTRA'", "'CREATEUSER'", "'NOCREATEUSER'", "'PORT'", 
