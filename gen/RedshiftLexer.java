...
public class RedshiftLexer extends RedshiftLexerBase {
	...
	public static final int
		...
		MAP=577, STRING=578, DELIMITED=579, RETRY_TIMEOUT=580, MAX_BATCH_SIZE=581, 
		MAX_PAYLOAD_IN_MB=582, KB=583, INCLUDE=584, ROUTINE=585, TRANSFORM=586, 
		IMPORT_P=587, POLICY=588, PRIORITY=589, METHOD=590, REFERENCING=591, NEW=592, 
		OLD=593, VALUE_P=594, SUBSCRIPTION=595, PUBLICATION=596, OUT_P=597, END_P=598, 
		ROUTINES=599, SCHEMAS=600, PROCEDURES=601, INPUT_P=602, SUPPORT=603, PARALLEL=604, 
		SQL_P=605, DEPENDS=606, OVERRIDING=607, CONFLICT=608, SKIP_P=609, LOCKED=610, 
		TIES=611, ROLLUP=612, CUBE=613, GROUPING=614, SETS=615, TABLESAMPLE=616, 
		ORDINALITY=617, XMLTABLE=618, COLUMNS=619, XMLNAMESPACES=620, ROWTYPE=621, 
		NORMALIZED=622, WITHIN=623, FILTER=624, GROUPS=625, OTHERS=626, NFC=627, 
		NFD=628, NFKC=629, NFKD=630, UESCAPE=631, VIEWS=632, NORMALIZE=633, DUMP=634, 
		PRINT_STRICT_PARAMS=635, VARIABLE_CONFLICT=636, ERROR=637, USE_VARIABLE=638, 
		USE_COLUMN=639, ALIAS=640, CONSTANT=641, PERFORM=642, GET=643, DIAGNOSTICS=644, 
		STACKED=645, ELSIF=646, WHILE=647, REVERSE=648, FOREACH=649, SLICE=650, 
		EXIT=651, RETURN=652, QUERY=653, RAISE=654, SQLSTATE=655, DEBUG=656, LOG=657, 
		INFO=658, NOTICE=659, WARNING=660, EXCEPTION=661, ASSERT=662, LOOP=663, 
		OPEN=664, ABS=665, CBRT=666, CEIL=667, CEILING=668, DEGREES=669, DIV=670, 
		EXP=671, FACTORIAL=672, FLOOR=673, GCD=674, LCM=675, LN=676, LOG10=677, 
		MIN_SCALE=678, MOD=679, PI=680, POWER=681, RADIANS=682, ROUND=683, SCALE=684, 
		SIGN=685, SQRT=686, TRIM_SCALE=687, TRUNC=688, WIDTH_BUCKET=689, RANDOM=690, 
		SETSEED=691, ACOS=692, ACOSD=693, ASIN=694, ASIND=695, ATAN=696, ATAND=697, 
		ATAN2=698, ATAN2D=699, COS=700, COSD=701, COT=702, COTD=703, SIN=704, 
		SIND=705, TAN=706, TAND=707, SINH=708, COSH=709, TANH=710, ASINH=711, 
		ACOSH=712, ATANH=713, BIT_LENGTH=714, CHAR_LENGTH=715, CHARACTER_LENGTH=716, 
		LOWER=717, OCTET_LENGTH=718, UPPER=719, ASCII=720, BTRIM=721, CHR=722, 
		CONCAT=723, CONCAT_WS=724, FORMAT=725, INITCAP=726, LENGTH=727, LPAD=728, 
		LTRIM=729, MD5=730, PARSE_IDENT=731, PG_CLIENT_ENCODING=732, QUOTE_IDENT=733, 
		QUOTE_LITERAL=734, QUOTE_NULLABLE=735, REGEXP_COUNT=736, REGEXP_INSTR=737, 
		REGEXP_LIKE=738, REGEXP_MATCH=739, REGEXP_MATCHES=740, REGEXP_REPLACE=741, 
		REGEXP_SPLIT_TO_ARRAY=742, REGEXP_SPLIT_TO_TABLE=743, REGEXP_SUBSTR=744, 
		REPEAT=745, RPAD=746, RTRIM=747, SPLIT_PART=748, STARTS_WITH=749, STRING_TO_ARRAY=750, 
		STRING_TO_TABLE=751, STRPOS=752, SUBSTR=753, TO_ASCII=754, TO_HEX=755, 
		TRANSLATE=756, UNISTR=757, AGE=758, CLOCK_TIMESTAMP=759, DATE_BIN=760, 
		DATE_PART=761, DATE_TRUNC=762, ISFINITE=763, JUSTIFY_DAYS=764, JUSTIFY_HOURS=765, 
		JUSTIFY_INTERVAL=766, MAKE_DATE=767, MAKE_INTERVAL=768, MAKE_TIME=769, 
		MAKE_TIMESTAMP=770, MAKE_TIMESTAMPTZ=771, NOW=772, STATEMENT_TIMESTAMP=773, 
		TIMEOFDAY=774, TRANSACTION_TIMESTAMP=775, TO_TIMESTAMP=776, TO_CHAR=777, 
		TO_DATE=778, TO_NUMBER=779, ENCODE=780, DISTKEY=781, SORTKEY=782, CASE_SENSITIVE=783, 
		CASE_INSENSITIVE=784, Identifier=785, QuotedIdentifier=786, UnterminatedQuotedIdentifier=787, 
		InvalidQuotedIdentifier=788, InvalidUnterminatedQuotedIdentifier=789, 
		UnicodeQuotedIdentifier=790, UnterminatedUnicodeQuotedIdentifier=791, 
		InvalidUnicodeQuotedIdentifier=792, InvalidUnterminatedUnicodeQuotedIdentifier=793, 
		StringConstant=794, UnterminatedStringConstant=795, UnicodeEscapeStringConstant=796, 
		UnterminatedUnicodeEscapeStringConstant=797, BeginDollarStringConstant=798, 
		BinaryStringConstant=799, UnterminatedBinaryStringConstant=800, InvalidBinaryStringConstant=801, 
		InvalidUnterminatedBinaryStringConstant=802, HexadecimalStringConstant=803, 
		UnterminatedHexadecimalStringConstant=804, InvalidHexadecimalStringConstant=805, 
		InvalidUnterminatedHexadecimalStringConstant=806, Integral=807, NumericFail=808, 
		Numeric=809, PLSQLVARIABLENAME=810, PLSQLIDENTIFIER=811, Whitespace=812, 
		Newline=813, LineComment=814, BlockComment=815, UnterminatedBlockComment=816, 
		MetaCommand=817, EndMetaCommand=818, ErrorCharacter=819, EscapeStringConstant=820, 
		UnterminatedEscapeStringConstant=821, InvalidEscapeStringConstant=822, 
		InvalidUnterminatedEscapeStringConstant=823, AfterEscapeStringConstantMode_NotContinued=824, 
		AfterEscapeStringConstantWithNewlineMode_NotContinued=825, DollarText=826, 
		EndDollarStringConstant=827, AfterEscapeStringConstantWithNewlineMode_Continued=828;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'DELIMITED'", "'RETRY_TIMEOUT'", "'MAX_BATCH_SIZE'", "'MAX_PAYLOAD_IN_MB'", 
	...
	private static final String _serializedATNSegment0 =
		...
		"\u0000!!##%&**<@^^``||~~\u0002\u0000*+<>\b\u0000!!##%&?@^^``||~~\u0002"+
		"\u0000AAaa\u0002\u0000LLll\u0002\u0000NNnn\u0002\u0000YYyy\u0002\u0000"+
		"SSss\u0002\u0000EEee\u0002\u0000ZZzz\u0002\u0000DDdd\u0002\u0000RRrr\u0002"+
		"\u0000CCcc\u0002\u0000MMmm\u0002\u0000TTtt\u0002\u0000IIii\u0002\u0000"+
		"BBbb\u0002\u0000OOoo\u0002\u0000HHhh\u0002\u0000KKkk\u0002\u0000UUuu\u0002"+
		"\u0000GGgg\u0002\u0000PPpp\u0002\u0000FFff\u0002\u0000XXxx\u0002\u0000"+
		"VVvv\u0002\u0000QQqq\u0002\u0000WWww\u0002\u0000JJjj\t\u0000AZ__az\u00aa"+
		"\u00aa\u00b5\u00b5\u00ba\u00ba\u00c0\u00d6\u00d8\u00f6\u00f8\u00ff\u0002"+
		"\u0000\u0100\u8000\ud7ff\u8000\ue000\u8000\uffff\u0001\u0000\u8000\ud800"+
		"\u8000\udbff\u0001\u0000\u8000\udc00\u8000\udfff\u0002\u0000\u0000\u0000"+
		"\"\"\u0001\u0000\"\"\u0001\u0000\'\'\u0001\u000001\u0003\u000009AFaf\u0003"+
