...
selectIntoStatement
    : withClause? selectClause intoClause fromClause? whereClause? connectByClause? 
      groupByClause? havingClause? qualifyClause? setOperationClause?
      orderByClause? limitClause? offsetClause?
    ;

// INTO clause - specific to SELECT INTO
intoClause
    : INTO temporaryOption? TABLE? newTableName
    ;
...
// Nested SELECT statement for CTEs and subqueries
selectStatement
