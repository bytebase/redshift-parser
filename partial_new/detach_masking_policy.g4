// DETACH MASKING POLICY statement grammar for Amazon Redshift
// Reference: https://docs.aws.amazon.com/redshift/latest/dg/r_DETACH_MASKING_POLICY.html

grammar DetachMaskingPolicy;

// Parser Rules
detachMaskingPolicyStatement
    : DETACH MASKING POLICY policyName=identifier
