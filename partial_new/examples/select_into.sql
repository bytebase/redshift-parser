...
-- SELECT INTO with multiple set operations
SELECT eventid FROM event WHERE catid = 1
UNION
SELECT eventid FROM event WHERE catid = 2
INTERSECT
SELECT eventid FROM event WHERE venueid > 100
INTO complex_event_set;
