...
ALTER ROLE sample_role1 RENAME TO sample_role2, OWNER TO user2;
ALTER ROLE sample_role1 WITH RENAME TO sample_role2, OWNER TO user2;
ALTER ROLE role1 OWNER TO admin, EXTERNALID TO "EXT123";
ALTER ROLE role1 WITH OWNER TO admin, EXTERNALID TO "EXT123";
ALTER ROLE test_role RENAME TO prod_role, OWNER TO prod_admin, EXTERNALID TO "PROD_ID";
